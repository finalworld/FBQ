...
## 0.402: nytt komplett set med tolv värdeben

- Rita om samtliga tolv lösa ben. Alla ska vara tydliga, kraftiga hundben med samma grundform och läsbara även som små kartikoner.
- Skillnaden i färg, material, silhuett och glans ska öka logiskt med värdet. Bilder, namn, bentyp och servervärde måste kopplas en-till-en.
- Föreslagen ordning med nuvarande värden: Vanligt ben (1), Slitet ben (2), Jordben (3), Mossben (5), Järnben (8), Kopparben (12), Rubinben (20), Ametistben (35), Iskristallben (60), Diamantben (100), Guldben (175) och Stjärnben (300).
- Mossben får aldrig heta rent, det blå facetterade benet ska vara Diamantben och det gyllene benet ska vara Guldben.
- Konceptarket finns i `docs/design/bones-v0402-concept-chroma.png`. Inför implementeringen ska varje ben exporteras som en egen centrerad PNG med transparent bakgrund, identisk canvasstorlek och verifierad kartläsbarhet.
